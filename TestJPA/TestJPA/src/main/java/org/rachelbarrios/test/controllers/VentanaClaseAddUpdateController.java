...
public class VentanaClaseAddUpdateController implements Initializable{
    ...
    @FXML private TextField txtCantidadAsignaciones;
    ...
    public void initialize(URL location, ResourceBundle resources) {
       salon=FXCollections.observableArrayList((List<Salon>)Conexion.getInstancia().findAll("Salon.findAll"));
        ...
        instructor=FXCollections.observableArrayList((List<Instructor>)Conexion.getInstancia().findAll("Instructor.findAll"));
    ...
    public void guardar(){
        ...
        || txtCupoMinimo.getText().isEmpty()|| txtCantidadAsignaciones.getText().isEmpty()|| cmbCarrera.getSelectionModel().getSelectedItem()==null || cmbSalon.getItems().isEmpty()|| cmbInstructor.getItems().isEmpty()|| cmbHorario.getItems().isEmpty()) {
